...
<!--文件体开始-->
		...
		<tr>
			...
			<font color="#ffffff"><b>用户信息</b></font>
			<input type="button" value="修改" onclick="javascript:window.location='userinfo.jsp';">
			</td>
		</tr>
		<tr>
...
<!--文件尾开始-->
		...
		<tr>
			...
			<input type="button" value="修改" onclick="javascript:window.location='user/shopcart.jsp';">
			</td>
		</tr>
		...
		<tr>
			...
			<a href="productDetail.jsp?productid=2" target="_blank">
			${entry.value.book.name }</a></td>
			<td class=tablebody2 valign=middle align=center width="">
			价格：${entry.value.book.price }</td>
			<td class=tablebody1 valign=middle align=center width="">
			数量：${entry.value.num}</td>
			<td class=tablebody2 valign=middle align=left width="">
			小计：￥${entry.value.book.price * entry.value.num}</td>
		</tr>
        </c:forEach>       
		<tr>
			<td class=tablebody1 valign=middle align=center colspan="4">　</td>
			<td class=tablebody1 valign=middle align=left width="">
			合计：<font color="#ff0000"><b>￥${shoppingCar.cost }</b></font></td>
		</tr>
		        </table>
		        <p align="center">请认真检查以上订单信息，确认无误后，点击 → 
		        <a onclick="javascript:document.order.submit();" style="cursor:hand">
		        <img src="images/submit.gif"></a></p>
		</form>
